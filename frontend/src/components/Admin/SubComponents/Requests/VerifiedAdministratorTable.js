...
export class VerifiedAdministratorTable extends Component {
    linkFormatter = (cell, row, rowIndex) => {
        console.log(cell);
        console.log(row);
        //  console.log(cell);
        return (
            <Link to={"/admin/requests/verifiedAdministrators?id=" + row.user_id}>
                View Details
            </Link>
        );
    };
...
componentDidMount() {
    axios.get(`${url.BASE_URL}/verifiedAdministrators`).then((res) => {
...
export default VerifiedAdministratorTable